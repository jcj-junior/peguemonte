    ...
    <div className="bg-[#161B22] p-6 rounded-[2rem] border border-[#1E293B] space-y-4 hover:border-[#1D4ED8]/30 transition-all group shadow-xl">
        ...
        {trend && (
            <div className="flex items-center gap-2">
                ...
                <span className="text-[#64748B] text-[10px] font-bold uppercase tracking-wider italic">vs last month</span>
            </div>
        )}
        ...
        {progress !== undefined && (
            <div className="space-y-2">
                <div className="flex justify-between items-end">
                    <span className="text-[10px] font-black text-[#94A3B8] uppercase tracking-widest">{progress}% Available</span>
                </div>
...
const LogItem = ({ item, client, phone, time, status, type }) => {
    const statusConfig = {
        pickup: {
            'awaiting': { label: 'Awaiting Pickup', color: 'text-[#F59E0B] bg-[#F59E0B]/10' },
            'ready': { label: 'Ready', color: 'text-[#10B981] bg-[#10B981]/10' },
            'scheduled': { label: 'Scheduled', color: 'text-[#1D4ED8] bg-[#1D4ED8]/10' }
        },
        return: {
            'pending': { label: 'Awaiting Return', color: 'text-[#F59E0B] bg-[#F59E0B]/10' },
        ...
        <div className="space-y-10 animate-in fade-in slide-in-from-bottom-6 duration-700">
            ...
            <header className="flex justify-between items-center">
                <div>
                    ...
                    <p className="text-[#94A3B8] font-bold uppercase text-[10px] tracking-[0.2em]">Overview for <span className="text-[#1D4ED8]">Oct 24, 2023</span></p>
                </div>
                    ...
                    <div className="min-h-[300px]">
                        {activeTab === 'pickups' ? (
                            ...
                            <div className="flex flex-col items-center justify-center py-20 opacity-20">
                                ...
                                <p className="font-bold uppercase tracking-widest text-xs mt-4 text-[#64748B]">No returns scheduled for today</p>
                            </div>
                        )}
                    </div>
                    <div className="p-4 flex justify-between items-center border-t border-[#1E293B] mt-4">
                        <p className="text-[10px] font-bold text-[#64748B] uppercase tracking-widest">Showing 4 of 12 pickups</p>
                        <div className="flex gap-2">
                            <button className="px-4 py-2 bg-[#0B0E14] border border-[#1E293B] rounded-xl text-[10px] font-black text-[#64748B] hover:text-white transition-all shadow-inner">Prev</button>
                            <button className="px-4 py-2 bg-[#1D4ED8]/10 border border-[#1D4ED8]/20 rounded-xl text-[10px] font-black text-[#1D4ED8] hover:bg-[#1D4ED8] hover:text-white transition-all">Next</button>
                        </div>
                    </div>
                </div>
            </div>
